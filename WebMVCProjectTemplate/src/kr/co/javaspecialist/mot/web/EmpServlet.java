package kr.co.javaspecialist.mot.web;
...
import kr.co.javaspecialist.mot.model.DeptVO;
...
public class EmpServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher disp = request.getRequestDispatcher("/WEB-INF/view/mot/" + path + ".jsp");
